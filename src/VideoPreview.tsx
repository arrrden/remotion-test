...
const Loading: FunctionComponent = () => <h1>Loading…</h1>;

const VideoPreview: FunctionComponent<Props> = ({ slides }) => {
  ...
  }, [config, frame, playing, setFrame, video, currentComposition]);
